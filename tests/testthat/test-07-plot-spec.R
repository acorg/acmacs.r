...
test_that("rotation", { expect_equal(plot_spec$styles[[1]]$rotation, 0); expect_equal(plot_spec$styles[[22]]$rotation, 0) })
test_that("aspect", { expect_equal(plot_spec$styles[[1]]$aspect, 1); expect_equal(plot_spec$styles[[22]]$aspect, 1) })
